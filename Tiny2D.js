...
// Tiny2D.js の一番最後に貼り付けて保存してください
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        Engine: typeof Engine !== 'undefined' ? Engine : window.Engine,
        RectangleEntity: typeof RectangleEntity !== 'undefined' ? RectangleEntity : window.RectangleEntity,
        CircleEntity: typeof CircleEntity !== 'undefined' ? CircleEntity : window.CircleEntity,
        LineEntity: typeof LineEntity !== 'undefined' ? LineEntity : window.LineEntity,
        BodyStatic: typeof BodyStatic !== 'undefined' ? BodyStatic : window.BodyStatic,
        BodyDynamic: typeof BodyDynamic !== 'undefined' ? BodyDynamic : window.BodyDynamic,
        ShapeRectangle: typeof ShapeRectangle !== 'undefined' ? ShapeRectangle : window.ShapeRectangle,
        ShapeCircle: typeof ShapeCircle !== 'undefined' ? ShapeCircle : window.ShapeCircle,
        ShapeLine: typeof ShapeLine !== 'undefined' ? ShapeLine : window.ShapeLine
    };
}